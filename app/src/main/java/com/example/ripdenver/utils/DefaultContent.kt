...
object DefaultContent {
    ...
    val defaultCards = listOf(
        // Basic communication cards (no folder)
        mapOf(
            "label" to "Oo",
            "vocalization" to "Oo",
        ...
        // Pang-araw-araw (Daily Activities) folder cards
        mapOf(
            "label" to "Matulog",
        ...
        // Pakiramdam (Feelings) folder cards
        mapOf(
            "label" to "Masaya",
